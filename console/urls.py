...
from .views import (create_project, datasets, delete_dataset, delete_project,
                    eda_page, get_datasets, index, new_project, project_detail,
                    projects, upload)
...
urlpatterns = [
    ...
    path('project/<str:project_id>/experiment/create/', new_project, name='create_experiment'),
